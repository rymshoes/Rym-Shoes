                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <p className="font-semibold">
                          {Math.round(parseFloat(product.price) * qty)
                            .toString()
                      ...
                      <button
                        ...
                        className="mt-3 text-[9px] tracking-widest uppercase text-warm-gray hover:text-warm-black underline"
                      >
                        Remove
                      </button>
                    </div>
